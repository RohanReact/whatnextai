  ...
  return (
    <PageWrapper>
      <main className="mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center px-6 py-16 text-center">
        <h1 className="font-display text-3xl font-bold text-on-surface">Create account</h1>
        <p className="font-sans mt-4 text-on-surface-variant">
          Sign up will be available soon. For now, use Begin My Journey on the home
          screen to try WhatNext.
        </p>
        <Link
          to="/"
